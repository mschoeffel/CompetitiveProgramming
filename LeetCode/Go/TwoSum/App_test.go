...
func TestApp(t *testing.T) {
	testSets := []InputCase{
		{nums: []int{2, 7, 11, 15}, target: 9, expected: []int{0, 1}, comment: "Example1"},
		{nums: []int{3, 2, 4}, target: 6, expected: []int{1, 2}, comment: "Example2"},
		{nums: []int{3, 3}, target: 6, expected: []int{0, 1}, comment: "Example3"},
